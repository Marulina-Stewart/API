      ...
      <div className="profil">
        ...
        <div className="details">
          ...
          <div className="groupe">
            ...
            <div className="Addressdetails">
              ...
              <p className="Label">
                ...
                <span className="persondetails">
                  {" "}
                  {person && person.address && person.address.suite}{" "}
                </span>
              </p>
              <p className="Label">
                {" "}
              ...
              <p className="Label">
                ...
                <span className="persondetails">
                  {" "}
                  {person && person.address && person.address.zipcode}{" "}
                </span>
              </p>
            </div>
          </div>
          <p className="Label">
            ...
            <span className="persondetails">
              {" "}
              {person && person.company && person.company.name}{" "}
            </span>
          </p>
          <p className="Label">
            Phone number:
